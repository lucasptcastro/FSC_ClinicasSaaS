...
const formSchema = z
  .object({
    ...
    appointmentPrice: z.number().min(1, "Preço do atendimento é obrigatório"),
...
export function UpsertDoctorForm({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    shouldUnregister: true, // reseta os campos quando o dialog é fechado
  ...
  // reseta o formulário quando o dialog é aberto
  useEffect(() => {
    if (isOpen) {
      form.reset({
        name: doctor?.name ?? "",
          ...
          <DialogFooter>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      e remover todos os dados do médico do sistema.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
            ...
            <Button type="submit" disabled={upsertDoctorAction.isPending}>
              {upsertDoctorAction.isPending ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  {doctor ? "Atualizando..." : "Adicionando..."}
                </>
              ) : (
